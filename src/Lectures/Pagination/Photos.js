...
class Photos extends Component {
  ...
  // 데이터 로딩
  componentDidMount() {
    this.fetchPhotos(this.state.currentIdx);
  }

  // componentDidUpdate(prevProps, prevState) {
  //   // if(prevProps.match.params.id !== prevState.currentIdx) {
  //   // // this.fetchPhotos(prevState.currentIdx);
  //   // // }
  //   // return
  // }
  ...
  fetchPhotos = (offset) => {
    ...
    fetch(
      `http://localhost:3001/photos/limit=${LIMIT}&offset=${nextoffset}.json`
    )
      .then((res) => res.json())
